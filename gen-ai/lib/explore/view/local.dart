...
class Local extends StatefulWidget {
  ...
  const Local({Key? key, required this.location}) : super(key: key);
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "messages": [
            {"role": "user", "content": "Give a list of good tourist attractions in ${widget.location}"}
          ]
        }),
      );
