...
class Currency extends StatefulWidget {
  ...
  const Currency({Key? key, required this.location}) : super(key: key);
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "messages": [
            {"role": "user", "content": 'Convert {$_locationController.text} to the currency that is used in ${widget.location}'} // Use the text from the controller
          ]
        }),
      );
      ...
      body: Column(
        children: <Widget>[
          ...
          TextField(
            ...
            decoration: InputDecoration(labelText: 'Convert', hintText: 'Enter your home currency value (also enter the name)'),
          ),
